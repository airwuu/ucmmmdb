...
// associated name
export const nameDay: Array<string> = [ // also known as menu group
  "sunday", 
  "monday" ,
  "tuesday" ,
  "wednesday" ,
...
export const nameLocation: Array<string> = [ // also known as menu group
  "pav",
  "dc"
];
export const nameCategoryPav: Array<string> = [ // category
  'breakfast',
  'lunch',
  'dinner'
];
export const nameCategoryDC: Array<string> = [ // category
  'lunch',
  'dinner',
  'late_night'
];
